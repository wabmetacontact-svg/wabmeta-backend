...
router.get('/wallet/pending-topups', auth_1.authenticate, walletController.getPendingTopUps);
// ✅ NEW: Retry failed topup verification
router.post('/wallet/topup/retry', auth_1.authenticate, walletController.retryTopUp);
// ─── Admin Routes ──────────────────────────────────────────────────────────────
